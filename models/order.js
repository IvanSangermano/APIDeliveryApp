...
Order.updateToDispatched = (id_order, ip_delivery, result) => {
    const sql=`
    UPDATE
        orders
    SET
...
Order.updateToOnTheWay = (id_order, ip_delivery, result) => {
    const sql=`
    UPDATE
        orders
    SET
...
Order.updateToDelivered = (id_order, ip_delivery, result) => {
    const sql=`
    UPDATE
        orders
    SET
